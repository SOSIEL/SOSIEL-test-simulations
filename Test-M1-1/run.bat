...
if exist spp-biomass-log.csv ren spp-biomass-log.csv spp-biomass-log-%fullstamp%.csv

call landis-ii-7 input_scenario_SHE.txt 2>&1 | tee "simulation-%fullstamp%.log"
